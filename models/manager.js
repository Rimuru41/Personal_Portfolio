...
export async function add_project(project) {
    try {
        await pool.query('INSERT INTO projects (Project_Name, Description, Tech_Stack, Link) VALUES ($1, $2, $3, $4)',
...
export async function update_project(id, project) {
    try {
        await pool.query('UPDATE projects SET Project_Name = $1, Description = $2, Tech_Stack = $3, Link = $4 WHERE id = $5',
